<template>
  <el-card class="box-card" >
    ...
    <el-descriptions
      ...
      <el-descriptions-item v-if="profileList.originCountry !== ''">
        <template #label>
          <div class="cell-item">
  ...
  methods: {
    getProfileData: function () {
      ...
      this.axios.request({
        ...
        that.loading = false
        that.profileList = response.data
